                    ...
                    (<form onSubmit={handleSubmit(handleForm)} className="w-full md:w-1/2 lg:w-1/2">
                        <div className="relative z-0 w-full mb-5 group">
                            <input
                                ...
                                {...register("product_name", { required: true })} type="text" id="floating_email" className={`block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none ${errors.product_name ? 'border-red-500' : ''} focus:border-blue-600 peer`} placeholder="" />
